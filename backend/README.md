...
## Project Structure
    ...
    ├── testapiautosetting_125693  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125693`
...
2. Clone this repo and `cd testapiautosetting_125693`
